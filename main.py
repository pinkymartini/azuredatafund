...
urlList = [
    ...
    "https://www.wedskenya.com/wp-content/uploads/2018/12/Sweet-Good-Morning-Wishes.jpg?ezimgfmt=rs:352x396/rscb5/ngcb5/notWebP"
...
'Lots of hugs and kisses from me, May you start your day with more energy than yesterday Good Morning! wedskenya.com',
...
for x in range(len(urlList)):
    endpoint = "https://cv-datafund.cognitiveservices.azure.com/vision/v3.2/read/analyze"
    key = "7de3c8cc388d4ae2a99db1771d4ee186"

    endpointResults = "https://cv-datafund.cognitiveservices.azure.com/vision/v3.2/read/analyzeResults/"
    ...
    headers = {
        "Ocp-Apim-Subscription-Key": "7de3c8cc388d4ae2a99db1771d4ee186",
